			...
			<div className={classes.commentContainer}>
				...
				<Box className={classes.commentBox}>
					<div className={classes.commentItem}>
						...
						<Typography className={classes.time}>A muito tempo atrás</Typography>
					</div>
				</Box>
			</div>
		</Grow>
			...
			<div className={classes.commentContainer}>
				...
				<Box className={classes.commentBox}>
					<div className={classes.commentItem}>
						...
						<Typography className={classes.time}>{moment(createdAt).format('MMMM YYYY, dddd, HH:mm')}</Typography>
					</div>
		...
		<Root className={classes.root}>
			<div className={classes.outerContainer}>
				...
				<div style={{ width: '100%', display: userId ? 'block' : 'none' }}>
					<Typography gutterBottom variant="h6">Escreva um comentário</Typography>
					<TextField InputProps={{ style: { color: 'white' } }} fullWidth rows={10} variant="outlined" label="Commentário" multiline value={comment} onChange={(e) => setComment(e.target.value)} />
