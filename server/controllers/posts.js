...
export const getPost = async (req, res) => {
	...
	try {
		...
		if (!post || (post._private && post.creator !== req.userId)) return res.status(404).send('Nenhum post com este id')
...
export const updatePost = async (req, res) => {
	...
	if (!mongoose.Types.ObjectId.isValid(_id)) return res.status(404).send('Nenhum post com este id')
...
export const deletePost = async (req, res) => {
	...
	if (!mongoose.Types.ObjectId.isValid(id)) {
		return res.status(404).send('Nenhum post com este id')
	}
